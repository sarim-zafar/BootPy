...
def paragraph():
    opt=int(raw_input("Do you want to add a heading to the paragrah\n1)Yes\n2)No\nSelect an option:"))
    h=""
    if opt==1:
        h=heading()
        Final.append(" \n"+h)
        ...
        print("Wrong Input\nPlease try again")
        return "\n" 
    opt=int(raw_input("""Please select the format in which you want to write the paragraph:
1)Normal
2)Italics
3)Bold
Select an option:"""))
    if opt==1:
        ...
        print("Wrong Input\nPlease try again")
        return "\n" 
    opt1=int(raw_input("""Please select the Alignment of the in which you want to write the paragraph:
1)Left
2)Center
3)Right
Select an option:"""))
    if opt1==1:
        ...
        print("Wrong Input\nPlease try again")
        return "\n"
    text=raw_input("Now enter the text of the paragraph:")
    if opt!=1:
        text="<"+y+">\n\t\t\t\t"+text+"\n\t\t\t</"+y+">"
    z="\n\t\t<p"+x+">\n\t\t\t"+text+"\n\t\t</p>\n"
    print("All done\n")
...
while True:
    ...
    if a=="1":
        ...
        opt=raw_input("Do you want to write this data to any other page except(If not then it will be wirtten to index.html file)?\n1)Yes\n2)No\nPlease Choose your option:")
        if opt=="1":
